...
| EVAL-CM-001 | Farmer's Delight / Slice & Dice / Some Assembly Required / Create compatibility | One controlled MER-2A food-loop session: manual cooking, Slicer cutting, heated mixing, and component-aware sandwich pressing; no balance data is changed | [2026-09-14-merchant-food-loop-evaluation](test-profiles/2026-09-14-merchant-food-loop-evaluation.md), [Assert-MerchantSupplyChainEvidence.ps1](../tools/Assert-MerchantSupplyChainEvidence.ps1) | No reload or restart; existing owner-mod data only | [2026-09-14-merchant-food-loop-evaluation](test-profiles/2026-09-14-merchant-food-loop-evaluation.md) | Not applicable; no instance file is copied or changed | Static preflight prepared; focused laboratory session pending |
